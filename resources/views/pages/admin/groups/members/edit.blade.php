  ...
  <div class="col-md-12">
    <div class="card">
      <div class="card-header">
        <h4 class="card-title">Edit Group members</h4>
         </div>
           <div class="card-body">
        <form action="{{route('gmembers.update',$gmembers->id)}}" method="POST">
          @csrf
          @method('PUT')
          ...
          <div class="form-group">
            ...
            <textarea name="description" id="description" class="form-control" placeholder="Enter description">{{$gmembers->Groups->description}}</textarea>
            @error('description')
